...
public class PlaceOrderFormController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        cmbItemCode.getSelectionModel().selectedItemProperty().addListener((observableValue1, s1, t2) -> {
    ...
    private void searchCustomer(String id){
        ...
        Customer customer = CustomerController.getInstance().serchCustomer(id);
    ...
    private void searchItem(String id){
        ...
        Item item = ItemController.getInstance().serchItem(id);
    ...
    void btnAddToCartOnAction(ActionEvent event) {
        ...
        if (itemStock<qty){
            ...
            cartTms.add(new CartTm(itemCode,itemDescription,qty,unitPrice,total));
